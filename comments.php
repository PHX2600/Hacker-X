                ...
                <div class="comment clearfix" id="comment-<?php comment_ID(); ?>">
                    ...
                    <div class="commentWrapper floatRight">
                        ...
                        <div class="commentInfo clearfix">
                            <div class="floatLeft">
                                By, <?php comment_author_link(); ?> on <?php comment_date('F j, Y'); ?> at at <?php comment_time(); ?>
                            </div>
                            <div class="floatRight">
                                <?php edit_comment_link('Edit', null, ' | '); ?>
                                <a href="#comment-<?php comment_ID(); ?>" class="commentPermalink" alt="Permalink" title="Permalink">&nbsp;</a> 
                            </div>
                        </div>
